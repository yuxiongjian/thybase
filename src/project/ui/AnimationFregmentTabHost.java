...
public class AnimationFregmentTabHost extends FragmentTabHost {
	...
	public AnimationFregmentTabHost(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void setCurrentTab_1(int index) {
