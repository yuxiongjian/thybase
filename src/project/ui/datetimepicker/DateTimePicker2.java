package project.ui.datetimepicker;
...
public class DateTimePicker2 implements OnClickListener {
	...
	public DateTimePicker2(Activity a,
	...
	public View getDateTimePickerLayout() {
		...
		View titleView = View.inflate(activity, R.layout.dialog_title_holo, null);
		TextView textView = (TextView)titleView.findViewById(R.id.datetime_title);
		textView.setText("选择日期和时间");
		...
		linear_child.addView(titleView);
