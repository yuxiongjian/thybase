 ...
 *
 */
public class BaiduLocationOverlay extends ProjectActivity {
	/**
	 * 
	 */
	private static final long serialVersionUID = BaiduLocationOverlay.class.hashCode();

	public BaiduLocationOverlay() {
		super();
    ...
    public void requestLocClick(){
        ...
        Toast.makeText(BaiduLocationOverlay.this, "正在定位……", Toast.LENGTH_SHORT).show();
    }
    /**
     * 修改位置图标
     * @param marker
